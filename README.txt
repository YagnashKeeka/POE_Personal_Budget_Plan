...
----------------------------------------------------------------------------------------------------------
* 2. BRIEF DESCRIPTION (LECTURERS FEEDBACK)
I have input validation at all places that are expected, such as when the user enters a wrong 
input such as characters (@, # , %, ",") or aphabets, where a integer value is required. The error
would be caught stating the that the users input is incorrect. There is another input validation 
added at the number of months to pay off a loan for a property. It is stated that the number of
months should be between 240 - 360 months. If a number less than 240 or greater than 360 is entered,
it would show the error stating that the number of months has either exceeded 360 or is below 240.
----------------------------------------------------------------------------------------------------------
* 3. SYSTEM AND SOFTWARE REQUIREMENTS
